...
void PlayerWindow::disapear() {
    hide();
}
void PlayerWindow::showIt() {
    show();
}
// read in videos and thumbnails to this directory
std::vector<TheButtonInfo> PlayerWindow::getInfoIn (std::string loc) {
...
std::vector<TheButtonInfo> PlayerWindow::getInfo (std::string loc) {
